...
.. autoclass:: servers.core.MessageProcessor
	:members:

database.py
~~~~~~~~~~~

.. autoclass:: servers.database.ServerStorage
	:members:

main_window.py
~~~~~~~~~~~~~~

.. autoclass:: servers.main_window.MainWindow
	:members:

add_user.py
~~~~~~~~~~~

.. autoclass:: servers.add_user.RegisterUser
	:members:

remove_user.py
~~~~~~~~~~~~~~

.. autoclass:: servers.remove_user.DelUserDialog
	:members:

config_window.py
~~~~~~~~~~~~~~~~

.. autoclass:: servers.config_window.ConfigWindow
	:members:

stat_window.py
~~~~~~~~~~~~~~~~

.. autoclass:: servers.stat_window.StatWindow
	:members: